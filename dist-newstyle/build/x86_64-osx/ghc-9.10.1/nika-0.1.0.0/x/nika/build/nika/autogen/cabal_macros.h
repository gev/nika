...
/* package nika-0.1.0.0 */
#ifndef VERSION_nika
#define VERSION_nika "0.1.0.0"
#endif /* VERSION_nika */
#ifndef MIN_VERSION_nika
#define MIN_VERSION_nika(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_nika */
...
#define CURRENT_COMPONENT_ID "nika-0.1.0.0-inplace-nika"
